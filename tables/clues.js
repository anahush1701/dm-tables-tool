...
window.tablesDatabase.push({
    id: "clue-table",
    title: "Selectable Clue Matrix",
    description: "Roll a d100 to discover narrative clues tailored specifically to your active environment context.",
    type: "clue-matrix",
    environments: {
        Dungeon: [
        ...
        Wilderness: [
            ...
            "You meet an NPC who got into an altercation with the target. **[SUB_D4_ALTERCATION]**",
